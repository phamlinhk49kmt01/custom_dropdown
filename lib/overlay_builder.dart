...
class _OverlayBuilder<T> extends StatefulWidget {
  ...
  @override
  _OverlayBuilderState<T> createState() => _OverlayBuilderState();
}

class _OverlayBuilderState<T> extends State<_OverlayBuilder> {
